<?php
$file = 'resources/views/pos/verify.blade.php';
$content = file_get_contents($file);

// Replace the @if($booking->status === 'paid') ... @endif block at the bottom
// We need to carefully identify where it starts and ends.

$pattern = '/@if\(\$booking->status === \'paid\'\).*?@endif/s';
