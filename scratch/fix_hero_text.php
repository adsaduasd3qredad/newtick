...
<!-- Hero Section (Promotional Banner) -->
    <section class="relative bg-[#0b132b] overflow-hidden border-b border-gray-900">
        <!-- Background Image -->
        <div class="absolute inset-0 z-0">
            <img src="{{ asset('images/cosmos.jpg') }}" alt="Space Background" class="w-full h-full object-cover opacity-80 mix-blend-screen">
...
echo "Updated Hero Section with new text and centered layout\n";
